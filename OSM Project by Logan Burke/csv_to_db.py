...
with open('nodes.csv','rb') as temp:
...
with open('nodes_tags.csv','rb') as temp:
   csv_line = csv.DictReader(temp)
...
with open('ways_tags.csv','rb') as temp:
   csv_line = csv.DictReader(temp)
   to_db = [(i['id'],i['key'],i['value'].decode("utf-8"),i['type']) for i in csv_line]
...
with open('ways_nodes.csv','rb') as temp:
   csv_line = csv.DictReader(temp)
